...
var image=document.querySelector("#sharma>img").getAttribute("src");
var name=document.querySelector("#gs>h1").innerText;
var localprice=document.querySelector("#rahul>p:first-child>span").innerText;
var originalprice=document.querySelector("#rahul>p:nth-child(2)").innerText;
var obj={
    image_url:image,
    name:name,
    price:localprice,
